...
namespace DaydreamElements.ObjectManipulation {
  ...
  public abstract class BaseInteractiveNetObject : NetworkBehaviour,
  IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler {
    ...
    public BaseInteractiveNetObject.ObjectState State {
      get {
        return state;
      }
    }
    ...
    private void Select() {
      ...
      if (state != ObjectState.None || lastStateChangeFrame == Time.frameCount) {
        return;
			...
			NetworkPlayer.LocalPlayer.CmdAssignAuthority (netId);
